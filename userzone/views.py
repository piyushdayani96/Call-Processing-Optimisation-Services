...
def savecomplain(request):
    if request.session['userid']:
        ...
        com=Complain(name=name,gender=gender,address=address,contactno=contactno,subject=subject,complaintext=complaintext,emailaddress=emailaddress,complaindate=complaindate)
        com.save()
